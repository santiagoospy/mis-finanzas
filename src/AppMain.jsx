...
export default function App() {
 ...
 ce("p",{style:{fontSize:14,fontWeight:500,color:TX,marginBottom:4}},"Exportar datos"),
  ...
  ce("textarea",{id:"exportTA",readOnly:true,onFocus:e=>e.target.select(),style:{width:"100%",boxSizing:"border-box",height:80,resize:"none",fontSize:11,fontFamily:"monospace",background:"#fff",color:TX,border:"1px solid "+BD,borderRadius:8,padding:"9px 10px"}})
),
